...
'''
"""
Dette er ikke vores kode, der er ændret på få ting.
class DFRobot_RGBLCD1602 er ændret til LCD fordi det er nemmere at skrive.
Til denne class er der tilføjet standard attributer row og col som er 2 og 16.
Da LCD'et i dette projekt altid vil have disse værdier.
"""
...
class LCD:
    def __init__(self, rgb_addr=0x60, col=16, row=2):
        # self.i2c=i2c
        self._row = row
        self._col = col
